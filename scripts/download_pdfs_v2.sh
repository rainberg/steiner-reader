...
download_one() {
    ...
    HTTP_CODE=$(curl -s -f -o "$FILEPATH" -w "%{http_code}" --connect-timeout 15 --max-time 300 "$URL" 2>/dev/null)
...
GA_IDS="001 002 003 004 004a 005 006 007 008 009
